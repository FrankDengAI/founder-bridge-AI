...
const BADGES: BadgeDef[] = [
  ...
  { id: "open_palette", label: "极客", desc: "使用过命令面板", emoji: "⚡" },
  { id: "lesson_path", label: "路线生", desc: "学习路线至少完成 3 步", emoji: "🎓" },
  { id: "lesson_master", label: "通关者", desc: "学习路线全部完成", emoji: "🏁" },
  ...
  { id: "streak_freeze_used", label: "补签侠", desc: "使用过一次连续签到保护", emoji: "🛡️" },

...
- Name: browse-first-login.spec.ts >> 先逛后登 >> 游客点击 Feed 卡片弹出登录层
- Location: e2e\browse-first-login.spec.ts:14:7
...
Locator: locator('button[data-author]').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('button[data-author]').first()

```

```yaml
- text: App 模式
- toolbar "App shortcuts":
  - button "中文"
  - button "Notifications":
    - img
    - text: "3"
  - button "Team messages":
    - img

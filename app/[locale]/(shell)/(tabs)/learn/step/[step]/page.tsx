...
export default async function LearnStepPage({ params }: Props) {
  ...
  return (
    <div className="space-y-4 pb-10">
      <PageHeader
        title={t("stepHeader", { current: n, title: s.title })}
        subtitle={s.summary}
        backHref="/home"
      />

      <section className="glass-panel rounded-3xl p-4 shadow-soft ring-1 ring-white/70">
        <p className="text-xs font-semibold text-brand-900">{t("checklistTitle")}</p>
